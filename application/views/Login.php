      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" method="POST" action="<?= base_url();?>index.php/user/Login">
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" href="index.html" type="submit" name="masuk"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>

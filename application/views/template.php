  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?= base_url()?>index.php/user/home" class="logo"><b>Uri Gadget</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="" href="<?= base_url()?>index.php/user/home">
                          <i><img src="<?= base_url()?>assets/img/home.png" style="width: 20px; height: 20px;"></i>
                          <span>Home</span>
                      </a>
                  </li>
                  <li>
                    <a href="<?=base_url('index.php/kategori')?>">
                        <i><img src="<?= base_url()?>assets/img/kategori.png" style="width: 20px; height: 20px;" alt=""></i>
                        <span>Category</span>
                    </a>
                  </li>
                  <li>
                    <a href="<?=base_url('index.php/barang')?>">
                    <i><img src="<?= base_url()?>assets/img/folder.png" style="width: 20px; height: 20px;" alt=""></i>
                    <span>Things</span>
                    </a>
                  </li>
                  <li class="sub-menu">
                      <a href="<?= base_url()?>index.php/user/gallery" >
                          <i><img src="<?= base_url()?>assets/img/gal.png" style="width: 20px; height: 20px;"></i>
                          <span>Gallery</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                      <a href="<?= base_url()?>index.php/user/event" >
                          <i><img src="<?= base_url()?>assets/img/event.png" style="width: 20px; height: 20px;"></i>
                          <span>Event</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                          <a class="" href="<?= base_url()?>index.php/Pelanggan/DaftarPelanggan">
                          <i><img src="<?= base_url()?>assets/img/form.png" style="width: 20px; height: 20px;"></i>
                          <span>Form Customer</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                          <a class="" href="<?= base_url()?>index.php/Pelanggan/DataPelanggan">
                          <i><img src="<?= base_url()?>assets/img/customer.png" style="width: 20px; height: 20px;"></i>
                          <span>Customers</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                          <a class="" href="<?= base_url()?>index.php/user/data_diri">
                          <i><img src="<?= base_url()?>assets/img/develop.png" style="width: 20px; height: 20px;"></i>
